-- Frozen genuine v4 schema from cbde92f:server-workspace-db.js.
-- No v5 structures are created or removed to manufacture this fixture.

-- Migration 1: initial-normalized-workspace-schema
...
INSERT INTO workspace_info (id, schema_version, created_at, updated_at) VALUES (1, 1, '2026-01-01T00:00:00.000Z', '2026-01-01T00:00:00.000Z');
INSERT INTO workspace_schema_migrations (version, name, applied_at) VALUES (1, 'initial-normalized-workspace-schema', '2026-01-01T00:00:00.000Z');
PRAGMA user_version = 1;

-- Migration 2: maintenance-plan-archive-records
...
INSERT INTO workspace_schema_migrations (version, name, applied_at) VALUES (2, 'maintenance-plan-archive-records', '2026-01-01T00:00:00.000Z');
PRAGMA user_version = 2;

-- Migration 3: inventory-item-archive-records
...
INSERT INTO workspace_schema_migrations (version, name, applied_at) VALUES (3, 'inventory-item-archive-records', '2026-01-01T00:00:00.000Z');
PRAGMA user_version = 3;

-- Migration 4: staff-member-archive-records
...
INSERT INTO workspace_schema_migrations (version, name, applied_at) VALUES (4, 'staff-member-archive-records', '2026-01-01T00:00:00.000Z');
