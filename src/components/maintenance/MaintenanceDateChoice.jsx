  ...
  return <Dialog open={open} onOpenChange={(value) => { if (!value && !busy) onCancel(); }}>
    <DialogContent className="rounded-xl sm:max-w-sm" showCloseButton={!busy}>
      ...
      <div className="grid gap-2">
        ...
        <p className="px-1 text-xs text-slate-500">Keep the other recurring dates unchanged.</p>
        ...
        <p className="px-1 text-xs text-slate-500">Change this visit and future dates. Saved job and completion history stays in place.</p>
