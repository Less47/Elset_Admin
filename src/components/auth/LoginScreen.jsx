  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top,_rgba(15,144,205,0.18),_transparent_34%),linear-gradient(180deg,_#f8fbfd_0%,_#eef5f9_100%)] px-4 py-8">
      <div className="mx-auto flex min-h-[calc(100vh-4rem)] max-w-md items-center justify-center">
        <Card className="w-full rounded-[2rem] border-border bg-card/95 shadow-[0_24px_70px_rgba(15,23,42,0.12)] backdrop-blur">
          <CardContent className="p-8 sm:p-10">
            <div className="mb-8 flex flex-col items-center text-center">
              ...
              <p className="mt-6 text-xs font-semibold uppercase tracking-[0.24em] text-status-info">Elset</p>
              <h1 className="mt-2 text-3xl font-semibold tracking-tight text-foreground">Staff Login</h1>
            </div>
            <form className="grid gap-5" onSubmit={handleSubmit}>
              ...
              {error ? (
                <div className="rounded-2xl border border-status-danger-border bg-status-danger-surface px-4 py-3 text-sm text-status-danger">
                  {error}
                </div>
              ) : null}
