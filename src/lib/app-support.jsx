...
export const themePresets = [
  {
    id: "elset",
    label: "Elset Classic",
    description: "Brand blue with brighter orange accents and a cleaner, airier base.",
    values: {
      pageBackgroundStart: "#D6F0FF",
      pageBackgroundEnd: "#7CC0E6",
      sidebarSurface: "#F8FCFF",
      sidebarHeader: "#06679A",
      sidebarActive: "#FF9A2E",
      heroSurface: "#0B7DB8",
      actionColor: "#F47E1F",
      borderColor: "#163247",
      dialogSurface: "#F7FBFF",
    },
  },
  {
    id: "copper-dawn",
