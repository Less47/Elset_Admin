...
export const themePresets = [
  ...
  },
  {
    ...
    label: "Coastal",
    values: {
      pageBackgroundStart: "#F0F9FF",
      pageBackgroundEnd: "#E0F2FE",
      sidebarSurface: "#F8FAFC",
      sidebarHeader: "#0C4A6E",
      sidebarActive: "#0284C7",
      heroSurface: "#075985",
      actionColor: "#0EA5E9",
      borderColor: "#155E75",
      dialogSurface: "#EFF6FF",
    },
  },
  {
    id: "forest",
    label: "Forest",
    values: {
      pageBackgroundStart: "#F7FEE7",
      pageBackgroundEnd: "#ECFCCB",
      sidebarSurface: "#FFFBEB",
      sidebarHeader: "#365314",
      sidebarActive: "#65A30D",
      heroSurface: "#3F6212",
      actionColor: "#84CC16",
      borderColor: "#365314",
      dialogSurface: "#F7FEE7",
    },
  },
  {
    id: "graphite",
    label: "Graphite",
    values: {
      pageBackgroundStart: "#F8FAFC",
      pageBackgroundEnd: "#E2E8F0",
      sidebarSurface: "#E2E8F0",
      sidebarHeader: "#111827",
      sidebarActive: "#475569",
      heroSurface: "#1E293B",
      actionColor: "#334155",
      borderColor: "#334155",
      dialogSurface: "#E5E7EB",
    },
  },
];
